...
- Arquivo de ciclos: `receipts_cycle_metrics.jsonl`
- Arquivo de receipts: `execution_receipts.jsonl`
- Conclusão automática: **não eficaz**
...
|---|---|---:|---:|---:|---:|---:|
| últimos 5 ciclos | ⚪ | ⚪ sem dados | ⚪ sem dados | ⚪ sem dados | ⚪ sem dados | 0 |
